...
class CoursesPage2 extends StatelessWidget {
  ...
  final List<String> courseUrls = [
    'https://cursa.app/free-courses-sign-language-online',
    'https://alison.com/course/basics-of-british-sign-language',
    'https://www.startasl.com/learn-sign-language-asl/',
    'https://www.signschool.com/',
    'https://www.classcentral.com/subject/sign-language',
    'https://www.classcentral.com/subject/sign-language',
  ];

  CoursesPage2({super.key});
