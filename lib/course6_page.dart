...
class CoursesPage6 extends StatelessWidget {
  // URLs for each course
  final List<String> courseUrls = [
    'https://coursera.pxf.io/disability-awareness',
    'https://edx.sjv.io/able-minded-mental-health-and-people-with-intellec',
    'https://edx.sjv.io/through-my-eyes-intellectual-disability-healthcare',
    'https://fave.co/3T0U0c6',
    'https://www.futurelearn.com/courses/global-disability',
    'https://sarthakindia.org/skill-building.php',
  ];

  CoursesPage6({super.key});
